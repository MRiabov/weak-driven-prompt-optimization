...
def dspy_metric(example, prediction, trace=None, pred_name=None, pred_trace=None):
    """
...
def optimize_baseline(trainset, strong_model_name: str) -> PromptCandidate:
    ...
    return PromptCandidate(
        prompt_id=str(uuid.uuid4()), stage=PromptStage.BASELINE, content=prompt_content
    )
